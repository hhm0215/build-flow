...
- **상태**: IN_PROGRESS (현장 생성·거래처 등록·견적 확정·현장 수정·DRAFT 견적 수정/삭제·보증보험 OCR 실패 수동 보정/수정 완료; 확정본 삭제 정책 사용자 결정 대기, 매입·세금계산서 수정/삭제 동선 남음. 매입 UI와 Kafka 신뢰성 보강의 선후 순서 사용자 확인 중)
...
| 2026-09-20 | 보증보험 OCR 실패 수동 보정/수정 동선 완료 — UI 라이프사이클 P0의 매입·세금계산서 후속 유지 |
