...
class OutboxKafkaConfigTest {
    ...
    @Test
    void dedicatedStringProducerInheritsBrokerDurabilitySettings() {
        ...
        ObjectProvider<SslBundles> sslBundles = mock(ObjectProvider.class);

        var template = new OutboxKafkaConfig().outboxKafkaTemplate(properties, sslBundles);
